...
Реализован единый скрипт на Python с использованием библиотеки OpenCV, поддерживающий два режима работы:

- `simple` — простой трекинг объекта по ключевым точкам SIFT и гомографии;
- `flow` — улучшенный трекинг, совмещающий SIFT + гомографию с оптическим потоком Лукаса–Канаде и периодической реинициализацией.
